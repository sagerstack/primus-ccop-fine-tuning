...
- [ ] 09-01-PLAN.md — Neo4j Docker service (APOC) + neo4j-graphrag/neo4j deps + Neo4j/graph-model settings (D-01/D-06a/D-07/D-12)

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 09-02-PLAN.md — Emergent KG build (SimpleKGPipeline, no schema) + `ccop-eval graph build` (D-03/D-04/D-05/D-08/D-17)
