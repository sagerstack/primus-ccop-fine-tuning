...
| 10. Ontology-grounded GraphRAG (Neo4j, governed KG) | 10/11 | In Progress|  |
...
- [x] 09-03-PLAN.md — KG-quality inspection: `graph inspect/stats` (clause coverage, orphans, dupes) + Neo4j Browser workflow (D-18/D-19)

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 09-04-PLAN.md — Pluggable graph-retrieval provider + entity-anchored Neo4j adapter + `--mode graphrag` retrieval-node swap (D-06/D-09/D-11)

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 09-05-PLAN.md — CLI mode surface: graphrag on evaluate + graphrag/graph-retrieval-only on query + B04/B4 casing fix (D-10)
...
- [x] 10-03-PLAN.md — Wave 1: ontology discovery Method C (grounded synthesis) + gold-relation parser + coverage checks + curation gate (a) (D-01/02/04/08/09/17/18)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 10-04-PLAN.md — Wave 2: ontology Method B (clustering cross-check) + reconcile + curation gate (b) + LOCK ontology_config (D-01/05/14/17)
...
- [x] 10-07-PLAN.md — Wave 4: schema-constrained OntologyKGBuilder + entity resolution + entity→clause linker + build CLI (D-06/07/11)

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 10-08-PLAN.md — Wave 5: SHACL validation (shapes.ttl + pyshacl export + quarantine) + validate CLI (D-13)
- [x] 10-09-PLAN.md — Wave 5: clause-anchored ontology retrieval adapter + function-type routing + stable tie-break (D-12/11/15)

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 10-10-PLAN.md — Wave 6: deterministic clause-hit@3 harness (hit@3/recall@3/recall@pool) + gold-set cross-check (D-15)
...
- [x] 11-01-PLAN.md — Wave 0 (BLOCKING): fix clause-aware chunker (5.2->5.3) + re-ingest 7 PDFs w/ per-doc provenance + fail-loud clause-completeness gate (D-19/D-20/D-25)
...
- [x] 11-04-PLAN.md — Policy Graph Stage 1 CU classification (premise/meta-CU/actor-CU, warm-start) + Stage 2 4-tuple extraction (D-03/04/09)
